...
author: Max Fronek
categories: design packaging frontend product photography featured
...
images:
  - img_url: images/post_images/lstn/lstn-hero-a.jpg
    blockquote: During my time as creative director for LSTN Sound Co, I led all design efforts both internally as well as for global partnerships with Delta Air Lines, Chivas Regal, Spotify, and more. 
    position: 50% 25%
    title: Model Nick Shackleford poses with a pair of LSTN Troubadour headphones
  ...
  - img_url: images/post_images/lstn/lstn-web-1.jpg
    blockquote: LSTN's digital identity upholds our core tenant of clean, sophisticated design, allowing the company's products and mission to take center stage.
    heading: Frontend 
  ...
  - img_url: images/post_images/lstn-product/lstn-lineup.jpg
    blockquote: |
      I started doing principal photography for LSTN pre-launch, and stayed in that role during my time there. My shots have been used in just about any way possible&mdash;from packaging and ecommerce to full-size billboards.
    heading: Photography
